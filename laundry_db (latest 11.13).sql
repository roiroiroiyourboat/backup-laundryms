...
(530, 'sjdhajdha', '67000000000', ''),
(531, 'po', '87090000000', 'cititown'),
(532, 'shaun the sheep', '76509000000', 'farm'),
(548, 'Tobi', '87622222222', ''),
(549, 'Maggie Greene', '09897876654', 'farm');
...
(784, 531, 'ord_672b0781df8c4', 'po', '87090000000', 1, 'Wash/Dry/Fold', 2, 'Bedsheet/Table Cloths/Curtain', 2, 7, 45.00, '2024-11-09', '2024-11-06', '14:06:57', 'completed'),
(785, 532, 'ord_672b08178e58c', 'shaun the sheep', '76509000000', 1, 'Wash/Dry/Fold', 1, 'Clothes/Table Napkin/Pillowcase', 1, 7, 35.00, '2024-11-07', '2024-11-06', '14:09:27', 'completed'),
...
(806, 549, 'ord_673453da46d1c', 'Maggie Greene', '09897876654', 1, 'Wash/Dry/Fold', 1, 'Clothes/Table Napkin/Pillowcase', 1, 10, 35.00, '2024-11-14', '2024-11-13', '15:23:06', 'completed');
...
INSERT INTO `transaction` (`transaction_id`, `request_id`, `customer_id`, `customer_name`, `customer_address`, `province`, `city`, `brgy`, `service_option_id`, `service_option_name`, `laundry_cycle`, `total_amount`, `delivery_fee`, `rush_fee`, `amount_tendered`, `money_change`) VALUES
...
(547, 784, 531, 'po', 'cititown', '', '', '', 1, 'Delivery', 'Standard', 365.00, 50.00, 0.00, 500.00, 135.00),
(548, 785, 532, 'shaun the sheep', 'farm', '', '', '', 1, 'Delivery', 'Rush', 320.00, 50.00, 25.00, 500.00, 180.00),
(560, 805, 467, 'Tobi', 'berde', 'bulacan', 'sjdm', 'Gaya-gaya', 1, 'Delivery', 'Standard', 705.00, 25.00, 0.00, 1000.00, 295.00),
(561, 806, 549, 'Maggie Greene', 'farm', 'bulacan', 'sjdm', 'Gaya-gaya', 1, 'Delivery', 'Rush', 400.00, 25.00, 25.00, 500.00, 100.00);
...
--
ALTER TABLE `service_request`
  MODIFY `request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=807;
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=562;
