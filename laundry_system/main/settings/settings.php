        ...
        <div class="main-content">
            ...
            <div class="buttons">
                <div class="wdf_button">
                    <a href="/laundry_system/main/settings/categ1.php" class="button" id="wdfBtn">Wash/Dry/Fold</a>
                </div>
                    
                <div class="wdp_button">
                    <a href="/laundry_system/main/settings/categ2.php" class="button" id="wdpBtn">Wash/Dry/Press</a>
                </div>
                
                <div class="dry_button">
                    <a href="/laundry_system/main/settings/categ3.php" class="button" id="dryBtn">Dry only</a>
                </div>       
            </div> 
